  ...
  return (
    ...
    <motion.div
        ...
        <div>
          <Link
            href="/#contact"
            className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 to-yellow-500 hover:bg-slate-200 text-white"
          >
            Hire Me
          </Link>
          <Link
        ...
        <div className="rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative">
          <Image
            ...
            width={300}
            height={300}
            style={{ borderRadius: '45%',height:'80%' }}
          />
        </div>
        </motion.div>
    </div>
